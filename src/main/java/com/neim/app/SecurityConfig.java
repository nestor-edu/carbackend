...
import com.neim.app.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		config.setAllowedOrigins(Arrays.asList("*")); // define the origins localhost:PORT
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(serviceImpl).passwordEncoder(new BCryptPasswordEncoder());
	}
